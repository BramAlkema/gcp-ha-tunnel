...
#
# To enable this, add to your configuration.yaml:
#   homeassistant:
...
EOF
    ...
    bashio::log.warning "Google Assistant: Ensure 'homeassistant: packages: !include_dir_named packages' is in configuration.yaml"
}
